...
<div style={{
  ...
  <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 10 }}>
    ...
    <div style={{ display: 'flex', gap: 8, marginTop: 24, flexWrap: 'wrap', justifyContent: 'center' }}>
      {['Mobile Development', 'RF & Microwave Engineering', 'AI / ML', 'Product Design'].map(function(tag, i) {
        return (
          <span key={i} style={{
...
<div style={{
  ...
  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center', zIndex: 10, maxWidth: 760, padding: '0 20px' }}>
    {[
      ...
      { name: 'JavaScript', color: '240,219,79' },
      { name: 'Streamlit', color: '255,75,75' },
      { name: 'YOLOv8', color: '0,200,150' },
      { name: 'TanStack', color: '255,79,38' },
      { name: 'Tailwind', color: '56,189,248' },
      { name: 'Android Studio', color: '61,220,132' },
      { name: 'Keysight ADS', color: '255,153,0' },
...
<div style={{
  ...
  <div style={{
    ...
    <span style={{ fontSize: 22, fontWeight: 700, color: '#ffffff', lineHeight: 1.3 }}>
      Building practical tools at the intersection of mobile, hardware, and AI
    </span>
    ...
    <span style={{
      ...
      Student with broad technical interests spanning mobile development, RF/microwave engineering, and AI/ML. I build practical, real-world tools — from Android apps and computer-vision diagnostic pipelines to AI-powered design utilities — and I'm drawn to automation and entrepreneurship along the way.
    </span>

    <div style={{ display: 'flex', alignItems: 'center', marginTop: 8 }}>
      <span style={{ fontSize: 13, color: 'rgba(0,229,255,0.45)', fontFamily: 'monospace' }}>
        {'>'} android · rf/microwave · computer vision · automation
      </span>
...
<div style={{
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, zIndex: 10, width: '100%', padding: '0 28px' }}>
    {[
      {
        title: 'Radiova',
        desc: 'Dental X-ray AI diagnostic assistant — two-model YOLOv8 pipeline for tooth segmentation and condition detection, wrapped in a Streamlit app',
      ...
      {
        title: 'Nuansic',
        desc: 'AI-powered color palette generator web app with an interactive, hover-driven hero section',
      ...
      {
        title: 'Space Kids',
        desc: 'Educational solar system prototype for kids — animated planet orbits, planet detail pages, and full interaction flows',
      ...
      {
        title: 'BeeFlow',
        desc: 'Android Pomodoro timer with a foreground timer service, ambiance sounds, and dark/light theming',
        tech: 'Android',
        color: '255,193,7',
        statusId: 'pjs4'
      },
      {
        title: 'GreenDZ',
        desc: 'Algerian agritech startup exploration with a four-person team, focused on produce quality grading',
        tech: 'AgriTech · Product Strategy',
        color: '76,175,80',
        statusId: 'pjs5'
      }
...
<div style={{
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
      {[
        { label: 'Android Development', color: '0,229,255', id: 'cfd1' },
        { label: 'RF/Microwave Circuit Design', color: '139,92,246', id: 'cfd2' },
        { label: 'Computer Vision', color: '51,102,255', id: 'cfd3' },
        { label: 'AI/ML Fundamentals', color: '236,72,153', id: 'cfd4' },
        { label: 'Automation', color: '168,85,247', id: 'cfd5' },
        { label: 'Entrepreneurship', color: '0,180,255', id: 'cfd6' },
      ].map(function(item, i) {
        return (
          <div key={i} style={{
            display: 'flex', alignItems: 'center', gap: 8,
...
```aura width=130 height=44 link="https://github.com/yasminehamaili" inline align=center
<SocialMediaButton
...
```aura width=140 height=44 link="https://www.linkedin.com/in/yasmine-hamaili/" inline align=center
<SocialMediaButton
...
```aura width=120 height=44 link="mailto:yasmine.hamaili@gmail.com" inline align=center
<SocialMediaButton
